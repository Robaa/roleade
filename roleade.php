...
/*
Plugin Name: Roleade
Description: Useful and almighty Role management for WordPress
Author: Roel Baars
Author URI: 
Version: 0.0
*/
...
/*
No disclaimer whatsoever. Just do whatever you want.
*/
...
class RestrictCategories{
	...
	public function admin_scripts() {
		wp_enqueue_script( 'restrict-categories-admin', plugins_url( '/js/roleade.js', __FILE__ ), array( 'jquery' ), false, true );
	}
	...
	public function add_admin() {
		add_options_page( __('Roleade', 'restrict-categories'), __('Roleade', 'restrict-categories'), 'manage_categories', 'restrict-categories', array( &$this, 'admin' ) );
	}
	...
	?>
		...
		<div class="wrap">
			...
			<h2><?php _e('Roleade', 'restrict-categories'); ?></h2>
